...
export default function Multas() {
    ...
    const handleCambiarEstadoTipo = async (idTipo, nuevoEstado) => {
        try {
            ...
            setTiposMulta(prev => prev.map(t => (t.id === idTipo ? { ...t, estado: nuevoEstado } : t)));
        } catch (err) {
    ...
    const handleCambiarEstadoMulta = async (idMulta, estadoDestino) => {
        try {
            ...
            const msg =
                err.response?.data?.errors?.[0]?.msg || err.response?.data?.error || "Error al actualizar estado";
            showToast(msg, "error");
        }
    };
    ...
    const handleGuardarEdicionMulta = async e => {
        ...
        if (
            ...
            !editFormData.id_tipo_multa ||
            !editFormData.idApartamento
        ) {
        ...
        try {
            ...
            const msg =
                err.response?.data?.errors?.[0]?.msg || err.response?.data?.error || "Error al actualizar la sanción";
                ...
                <section className="sicrcb-multas-hero">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
                        <BotonReporte
                            ...
                            nombreArchivo="Reporte_Cartera_Multas_Admin.pdf"
                            texto="Generar Reporte"
                            className="btn btn-danger d-inline-flex align-items-center gap-2 shadow-sm fw-bold"
                        />
                        <div className="multas-hero-badge">
                            <ReceiptText size={16} stroke="#FFD0A0" />
                            <span>
                                {multas.length} Sanciones | {tiposMulta.length} Infracciones Catalogadas
                            </span>
                        </div>
                    </div>
                </section>
                                                ...
                                                <tr key={id}>
                                                    <td>
                                                        ...
                                                        <div style={{ fontSize: "0.8rem", color: "#735340" }}>
                                                            {m.descripcion
                                                                ? m.descripcion.substring(0, 48) + "..."
                                                                : ""}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <span style={{ fontWeight: "700", color: "#2c1203" }}>
                                                            {m.bloque || "Torre A"} • Int {m.interior || "1"} • Apto{" "}
                                                            {m.numero_apartamento || m.numero}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span
                                                    ...
                                                    <td style={{ minWidth: "155px" }}>
                                                        ...
                                                        >
                                                            <select
                                                                ...
                                                                value={estado}
                                                                onChange={e =>
                                                                    handleCambiarEstadoMulta(id, e.target.value)
                                                                }
                                                            >
                                                                <option
                                                                    value="Pendiente"
                        ...
                        <div className="form-card-body">
                            ...
                            <form onSubmit={handleCrearSubmit}>
                                ...
                                <div className="multas-grid-2col">
                                            ...
                                            {tiposMulta
                                                ...
                                                .map(t => (
                                                    <option key={t.id} value={t.id}>
                                                        #{t.numero} - {t.descripcion.substring(0, 45)}... ($
                                    ...
                                    <div className="multas-field-group">
                                        <label className="multas-label">
                                            Apartamento / Unidad (Torre • Int • Apto)
                                        </label>
                                        <select
                                            className="multas-select"
                                        ...
                                        >
                                            ...
                                            {apartamentos.map(a => (
                                                <option key={a.id} value={a.id}>
                                                    {a.bloque_nombre || a.bloque || "Torre A"} • Int {a.interior || "1"}{" "}
                                                    • Apto {a.numero}
                                                </option>
                                            ))}
                                        </select>
                    ...
                    <div className="sicrcb-table-card">
                        <div
                            style={{
                                ...
                                alignItems: "center",
                                borderBottom: "1px solid var(--multas-border)",
                            }}
                        >
                            <div>
                                <h3
                                    ...
                                    {tiposFiltrados.length === 0 ? (
                                        ...
                                        tiposFiltrados.map(t => (
                                            <tr key={t.id}>
                                                ...
                                                <td>
                                                    <div
                                                        style={{ color: "var(--multas-text-dark)", lineHeight: "1.4" }}
                                                    >
                                                        {t.descripcion}
                                                    </div>
                                                </td>
                                                ...
                                                <td style={{ verticalAlign: "middle" }}>
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() =>
                                                            handleCambiarEstadoTipo(
                                                                t.id,
                                                                t.estado === "Activa" ? "Inactiva" : "Activa",
                                                            )
                                                        }
                                                        style={{
                                                            display: "inline-flex",
                            ...
                            <form onSubmit={handleCrearTipoSubmit}>
                                ...
                                <div className="multas-field-group">
                                    ...
                                    <textarea
                                        ...
                                        onChange={e =>
                                            setNuevoTipoData({ ...nuevoTipoData, descripcion: e.target.value })
                                        }
                                        required
                                    />
                                </div>
                                ...
                                <div className="multas-grid-2col">
                                    <div className="multas-field-group">
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setNuevoTipoData({ ...nuevoTipoData, valor: e.target.value })
                                            }
                                            required
                                        />
                                    </div>
                                    ...
                                    <div className="multas-field-group">
                                        ...
                                        <select
                                            ...
                                            onChange={e =>
                                                setNuevoTipoData({ ...nuevoTipoData, estado: e.target.value })
                                            }
                                        >
                    ...
                    <div className="sicrcb-modal-card" onClick={e => e.stopPropagation()}>
                        <div className="modal-card-header">
                            ...
                            <button
                                ...
                                onClick={() => setModalEditTipoOpen(false)}
                            >
                                <X size={20} />
                            </button>
                        </div>
                    ...
                    >
                        ...
                        <form onSubmit={handleGuardarEdicionMulta}>
                            <div
                                ...
                                style={{ maxHeight: "72vh", overflowY: "auto", padding: "1.25rem 1.5rem" }}
                            >
                                {modalEditError && (
                                    <div
                                        style={{
                                ...
                                <div className="multas-grid-2col">
                                    <div className="multas-field-group">
                                        ...
                                        <select
                                            ...
                                            onChange={e =>
                                                setEditFormData({ ...editFormData, id_tipo_multa: e.target.value })
                                            }
                                            required
                                        >
                                            <option value="">Selecciona tipo de multa...</option>
                                            {tiposMulta
                                                .filter(
                                                    t =>
                                                        t.estado === "Activa" ||
                                                        String(t.id) === String(editFormData.id_tipo_multa),
                                                )
                                                .map(t => (
                                                    <option key={t.id} value={t.id}>
                                                        #{t.numero} - {t.descripcion.substring(0, 35)}... ($
                                                        {Number(t.valor || 0).toLocaleString("es-CO")})
                                                    </option>
                                                ))}
                                        </select>
                                    ...
                                    <div className="multas-field-group">
                                        ...
                                        <select
                                            ...
                                            onChange={e =>
                                                setEditFormData({ ...editFormData, idApartamento: e.target.value })
                                            }
                                            required
                                        >
                                            <option value="">Selecciona apartamento...</option>
                                ...
                                <div className="multas-grid-2col">
                                    <div className="multas-field-group">
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setEditFormData({ ...editFormData, evidencia: e.target.value })
                                            }
                                        />
                                    </div>
                    ...
                    <div className="sicrcb-modal-card" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-card-body">
                            <p style={{ margin: 0, color: "#594234", fontSize: "0.92rem", lineHeight: "1.5" }}>
                                ¿Estás seguro de que deseas eliminar este registro de sanción? Se removerá del estado de
