    ...
    const historialFiltrado = useMemo(() => {
        ...
        return historial
            ...
            .sort((a, b) => {
                if (orden === "reciente") {
                    return (
                        new Date(b.fecha_creacion || b.fechaEnvio || 0) -
                        new Date(a.fecha_creacion || a.fechaEnvio || 0)
                    );
                }
                if (orden === "antiguo") {
                    return (
                ...
                <div className="admin-pqrs-container">
                    <header className="admin-header">
                        ...
                        <p className="admin-subtitle">
                            Supervisa, atiende y actualiza las peticiones, quejas, reclamos y sugerencias radicadas por
                            los residentes del Conjunto Residencial Casa Blanca.
                        </p>
                    </header>
                    ...
                    <section className="main-card">
                        <div className="toolbar">
                            ...
                            <div className="toolbar-actions">
                                <BotonReporte
                                    endpoint="/reportes/admin/pqrs-pdf"
                                    nombreArchivo="Informe_Gestion_PQRS_Casa_Blanca.pdf"
                                    texto="Generar Informe PQRS (PDF)"
                                    className="btn btn-danger d-inline-flex align-items-center gap-2 shadow-sm fw-bold text-white px-3 py-2"
                                />
                                                    ...
                                                    <tr key={`pqr-row-${id}-${index}`}>
                                                        ...
                                                        <td>
                                                            <div className="date-cell">
                                                                ...
                                                                <span>
                                                                    {formatearFecha(
                                                                        pqr.fecha_creacion || pqr.fechaEnvio,
                                                                    )}
                                                                </span>
                                                            </div>
                                                        </td>
                                            ...
                                            <div key={`pqr-card-${id}-${index}`} className="mobile-pqr-card">
                                                ...
                                                <div className="mobile-card-body">
                                                    ...
                                                    <div className="mobile-info-row text-muted">
                                                        <Calendar size={14} />
                                                        <span>
                                                            {formatearFecha(pqr.fecha_creacion || pqr.fechaEnvio)}
                                                        </span>
                                                    </div>
                                ...
                                {totalPaginas > 1 && (
                                    <div className="pagination-bar">
                                        <span className="pagination-info">
                                            Página {paginaActual} de {totalPaginas} (Total: {historialFiltrado.length}{" "}
                                            PQRS)
                                        </span>
                    ...
                    <div className="modal-backdrop" onClick={() => setModalVer(null)}>
                        <div className="modal-window" onClick={e => e.stopPropagation()}>
                            <div className="modal-top">
                                ...
                                <button type="button" className="btn-modal-close" onClick={() => setModalVer(null)}>
                                    <X size={18} />
                                </button>
                            </div>
                            ...
                            <div className="modal-scroll-body">
                                <div className="modal-highlight-banner">
                                    <div className="highlight-item">
                                        ...
                                        <span
                                            className={`tipo-pill ${getTipoInfo(modalVer.tipo || modalVer.asunto).className}`}
                                        >
                        ...
                        <div className="modal-window modal-window-sm" onClick={e => e.stopPropagation()}>
                            ...
                            <form onSubmit={handleGuardarEstado}>
                                                ...
                                                >
                                                    ...
                                                    <div className="status-choice-info">
                                                        <div className="status-choice-header">
                                                            <span className={`status-pill ${est.badgeClass}`}>
                                                                {est.label}
                                                            </span>
                                                        </div>
                                ...
                                <div className="modal-bottom-actions">
                                    ...
                                    <button type="submit" className="btn-modal-primary" disabled={guardandoEstado}>
                                        {guardandoEstado ? (
                                            <>
                        ...
                        <div className="modal-window modal-window-sm" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-scroll-body text-center">
                                ...
                                <p className="danger-desc">
                                    Esta acción es definitiva y no se puede deshacer. Se eliminarán permanentemente el
                                    registro de la PQR y sus vinculaciones de la base de datos de Casa Blanca.
                                </p>
                                ...
                                <div className="danger-summary-box">
                                    ...
                                    <strong>Tipo:</strong>{" "}
                                    {getTipoInfo(modalEliminar.tipo || modalEliminar.asunto).label}
                                </div>
                            </div>
