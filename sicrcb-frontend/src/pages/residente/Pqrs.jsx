...
function Pqrs() {
    ...
    const historialFiltrado = useMemo(() => {
        return historial.filter(item => {
            const cumpleEstado =
                filtroEstado === "Todos" || getEstadoInfo(item.estado).badgeClass.includes(filtroEstado.toLowerCase());
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            setSuccess(
                nuevoId ? `¡PQR radicada con éxito! Número de radicado: #${nuevoId}` : "¡PQR radicada exitosamente!",
            );
            ...
            const serverMsg =
                err.response?.data?.error || err.response?.data?.message || "Ocurrió un error al radicar la PQR.";
            setError(serverMsg);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <>
            ...
            <div className="pqrs-page">
                <div className="pqrs-container">
                    ...
                    <header className="pqrs-header">
                        ...
                        <p className="pqrs-subtitle">
                            Radica peticiones, quejas, reclamos o sugerencias y haz seguimiento o actualización en
                            tiempo real.
                        </p>
                    </header>
                        ...
                        <section className="pqrs-card form-container">
                            ...
                            <form onSubmit={handleSubmit} className="pqrs-form">
                                ...
                                <div className="form-group">
                                    ...
                                    <p className="field-hint">{TIPOS_PQR.find(t => t.id === formData.tipo)?.desc}</p>
                                </div>
                                ...
                                <div className="form-actions">
                                    <button type="submit" className="btn-submit-pqr" disabled={loading}>
                                        <Send size={16} />
                                ...
                                <div className="process-steps">
                                    <div className="step-item">
                                        ...
                                        <div className="step-text">
                                            ...
                                            <p>
                                                Puedes editar la descripción o el tipo de tu solicitud mientras la
                                                administración no la haya tomado en revisión.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="step-item">
                                        ...
                                        <div className="step-text">
                                            ...
                                            <p>
                                                Al pasar a estado "En proceso" o "Resuelta", la PQR se bloquea para
                                                conservar la validez legal del radicado.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr key={pqr.id}>
                                                    ...
                                                    <td style={{ textAlign: "right" }}>
                                                        <div className="table-actions-group">
                                                            <BotonReporte
                                                                endpoint={`/reportes/residente/comprobante-pqr-pdf/${pqr.id}`}
                                                                nombreArchivo={`Radicado_PQR_${pqr.id}.pdf`}
                                                                texto="Radicado"
                ...
                {/* Modal de Detalle */}
                {pqrSeleccionada && (
                    <div className="modal-overlay" onClick={() => setPqrSeleccionada(null)}>
                                    ...
                                    <div className="detail-item">
                                        ...
                                        <span className="detail-value">
                                            {pqrSeleccionada.fecha_creacion
                                                ? new Date(pqrSeleccionada.fecha_creacion).toLocaleString("es-CO")
                                                : "No registrada"}
                                        </span>
                                    </div>
                                </div>
                ...
                {pqrAEditar && (
                    <div className="modal-overlay" onClick={() => !guardandoEdicion && setPqrAEditar(null)}>
                        <div className="modal-card" onClick={e => e.stopPropagation()}>
                            <div className="modal-header">
                                <div className="header-title-group">
                            ...
                            <form onSubmit={handleGuardarEdicion}>
                                <div className="modal-body">
                                    ...
                                    <div className="form-group">
                                        <div className="label-with-counter">
                                            ...
                                            <span className="char-counter">{editForm.descripcion.length}/500</span>
                                        </div>
                                        <textarea
                                            rows={5}
                                            maxLength={500}
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="submit" className="btn-modal-save" disabled={guardandoEdicion}>
                                        <Save size={15} />
