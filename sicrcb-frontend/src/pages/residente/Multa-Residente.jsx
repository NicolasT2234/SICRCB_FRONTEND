...
export default function MultaResidente() {
    ...
    const resueltasCount = multas.filter(
        m => (m.estado || "").toLowerCase() === "resuelta" || (m.estado || "").toLowerCase() === "pagada",
    ).length;
            ...
            <main className="multas-main-container">
                ...
                <section className="sicrcb-multas-hero">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
                        <BotonReporte
                            endpoint="/reportes/residente/paz-y-salvo-pdf"
                            nombreArchivo="Certificado_Paz_y_Salvo.pdf"
                            texto="Generar Paz y Salvo"
                            className="btn btn-success d-inline-flex align-items-center gap-2 shadow-sm fw-bold"
                        />
                        <div className="multas-hero-badge">
                            <ShieldCheck size={16} stroke="#FFD0A0" />
                            <span>
                                {pendientesCount === 0
                                    ? "Paz y Salvo de Convivencia"
                ...
                {loading ? (
                    ...
                    <div className="catalogo-residente-seccion">
                        <div style={{ marginBottom: "1.25rem" }}>
                            ...
                            <p style={{ margin: 0, color: "var(--multas-text-muted)", fontSize: "0.9rem" }}>
                                A continuación se relacionan los tipos de multas contemplados en el reglamento del
                                conjunto y sus tarifas vigentes:
                            </p>
                        </div>
                        ...
                        <div className="resident-multas-grid">
                            {catalogoTipos.map(tipo => (
                                <div
                                    key={tipo.id}
                                    className="resident-multa-card"
                                    style={{ borderLeft: "4px solid var(--multas-primary)" }}
                                >
                                    <div className="multa-card-header">
                                        ...
                                        <span
                                            className={`sicrcb-status-badge status-${tipo.estado === "Activa" ? "pagada" : "anulada"}`}
                                        >
                                            {tipo.estado}
                                        </span>
                                    </div>
                    ...
                    <div className="multas-empty-state">
                        ...
                        <p>
                            No tienes sanciones registradas en esta categoría. Gracias por mantener un ambiente
                            armonioso en el Conjunto Casa Blanca.
                        </p>
                    </div>
                ) : (
                                ...
                                <div key={m.id || m._id} className="resident-multa-card">
                                    ...
                                    <div className="multa-card-body">
                                        <p className="multa-card-desc">
                                            {m.descripcion ||
                                                "Infracción al reglamento de propiedad horizontal del conjunto."}
                                        </p>
                                        <div className="multa-amount-strip">
                    ...
                    <div className="sicrcb-modal-card" onClick={e => e.stopPropagation()} style={{ maxWidth: "540px" }}>
                        ...
                        >
                            <div>
                                ...
                                <div
                                    style={{ fontSize: "1.05rem", fontWeight: "800", color: "var(--multas-text-dark)" }}
                                >
                                    {multaDetalle.nombre}
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <p
                                    style={{
                                        ...
                                        fontSize: "0.88rem",
                                        color: "var(--multas-text-dark)",
                                        lineHeight: "1.4",
                                    }}
                                >
                                    {multaDetalle.descripcion_tipo_multa ||
                                        "Descripción según estatutos de propiedad horizontal."}
                                </p>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        style={{
                                            ...
                                            borderRadius: "6px",
                                            border: "1px dashed var(--multas-border)",
                                        }}
                                    >
                                        {multaDetalle.evidencia}
                                    </div>
                            ...
                            <div
                                style={{
                                    ...
                                    justifyContent: "space-between",
                                    alignItems: "center",
                                    borderTop: "1px solid var(--multas-border)",
                                    paddingTop: "1rem",
                                }}
                            >
                                <div>
                                    ...
                                    <div>
                                        <span
                                            className={`sicrcb-status-badge status-${(multaDetalle.estado || "pendiente").toLowerCase()}`}
                                        >
