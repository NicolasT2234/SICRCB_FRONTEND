...
function Perfil() {
    ...
    const fetchUser = async () => {
        ...
        try {
            ...
            const apellidosCargados =
                userData.apellidos || userData.apellido || authUser?.apellidos || authUser?.apellido || "";
                        ...
                        <div className="perfil-main-grid">
                            ...
                            <aside className="perfil-id-card">
                                <div className="id-card-top">
                                    ...
                                    <h2 className="user-fullname">{nombreCompletoMostrar}</h2>
                                    ...
                                    <div className="id-detail-item">
                                        ...
                                        <div>
                                            ...
                                            <span className="detail-value">
                                                ...
                                                {formData.numeroDocumento || "No registrado"}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="id-card-note">
                                    <Info size={15} />
                                    <p>
                                        Para cambios en tu documento, correo o cesión de apartamento, debes solicitarlos
                                        en la administración de Casa Blanca.
                                    </p>
                                </div>
